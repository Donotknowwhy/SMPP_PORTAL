...
const BRANDNAMES = toOptions(['GPAY', 'JOY'])
const NETWORKS = toOptions(['Tất cả', 'Viettel', 'Mobifone', 'Vinaphone'])
const PROVIDERS = toOptions(['ST', 'MobiOne', 'Gapit', 'VNPAY'])
const STATUSES = toOptions(['Active', 'Inactive'])
const PRIORITIES = toOptions([1, 2, 3, 4, 5])
const NETWORK_FILTER_OPTIONS = toOptions(['Tất cả', 'Viettel', 'Mobifone', 'Vinaphone'])
