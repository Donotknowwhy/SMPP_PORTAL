...
import { FileSearch2, ChevronDown, ChevronUp, RefreshCw, Search } from 'lucide-react'
...
const RESULT_ROWS = [
  { id: 1, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'GPAY', phone: '0707xxxx88', network: 'Viettel', dlr: 'DELIVRD', response: 'Success' },
  { id: 2, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'HIDBANK', phone: '0707xxxx89', network: 'Vinaphone', dlr: 'PENDING', response: 'Success' },
  { id: 3, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'HIDBANK', phone: '0707xxxx89', network: 'Vinaphone', dlr: 'PENDING', response: 'Success' },
  { id: 4, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'HIDBANK', phone: '0707xxxx89', network: 'Vinaphone', dlr: 'PENDING', response: 'Success' },
  { id: 5, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'HIDBANK', phone: '0707xxxx89', network: 'Vinaphone', dlr: 'PENDING', response: 'Success' },
  { id: 6, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'HIDBANK', phone: '0707xxxx89', network: 'Vinaphone', dlr: 'PENDING', response: 'Success' },
  { id: 7, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'HIDBANK', phone: '0707xxxx89', network: 'Vinaphone', dlr: 'PENDING', response: 'Success' },
  { id: 8, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'HIDBANK', phone: '0707xxxx89', network: 'Vinaphone', dlr: 'PENDING', response: 'Success' },
  { id: 9, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'HIDBANK', phone: '0707xxxx89', network: 'Vinaphone', dlr: 'PENDING', response: 'Success' },
  { id: 10, msgId: 'MSG_240615_001', sentAt: '15/06/2026 10:15', brandname: 'HIDBANK', phone: '0707xxxx89', network: 'Vinaphone', dlr: 'PENDING', response: 'Success' },
]
            ...
            <tbody>
              {RESULT_ROWS.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>{row.response}</td>
                  <td><a href="#detail" className="lk-detail-link">Chi tiết</a></td>
                </tr>
              ))}
            </tbody>
          </table>
